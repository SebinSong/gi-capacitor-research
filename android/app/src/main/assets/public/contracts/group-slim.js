...
|}`;
  ...
  var group_default = {
    ...
    groupMincomeCurrencyForGroup(state, getters) {
      return (state2) => {
        return getters.groupSettingsForGroup(state2).mincomeCurrency;
      };
    },
    ...
    groupCurrencyForGroup(state, getters) {
      return (state2) => {
        const mincomeCurrency = getters.groupMincomeCurrencyForGroup(state2);
  ...
  var proposals = {
    [PROPOSAL_INVITE_MEMBER]: {
      ...
      [VOTE_FOR]: async function(state, message) {
        ...
        await (0, import_sbp2.default)("gi.contracts/group/invite/process", forMessage, state);
    ...
    [PROPOSAL_REMOVE_MEMBER]: {
      ...
      [VOTE_FOR]: async function(state, message) {
        ...
        await (0, import_sbp2.default)("gi.contracts/group/removeMember/process", forMessage, state);
        (0, import_sbp2.default)(
          "gi.contracts/group/pushSideEffect",
          contractID,
    ...
    [PROPOSAL_GROUP_SETTING_CHANGE]: {
      ...
      [VOTE_FOR]: async function(state, message) {
        ...
        await (0, import_sbp2.default)("gi.contracts/group/updateSettings/process", forMessage, state);
        (0, import_sbp2.default)(
          "gi.contracts/group/pushSideEffect",
          contractID,
    ...
    [PROPOSAL_PROPOSAL_SETTING_CHANGE]: {
      ...
      [VOTE_FOR]: async function(state, message) {
        ...
        await (0, import_sbp2.default)("gi.contracts/group/updateAllVotingRules/process", forMessage, state);
        notifyAndArchiveProposal({ state, proposalHash, proposal, contractID, meta, height });
      },
      [VOTE_AGAINST]: voteAgainst
    },
  ...
  var leaveChatRoomAction = async (groupID, state, chatRoomID, memberID, actorID, leavingGroup) => {
    ...
    const extraParams = {};
    if (leavingGroup) {
      const encryptionKeyId = await (0, import_sbp3.default)("chelonia/contract/currentKeyIdByName", state, "cek", true);
      const signingKeyId = await (0, import_sbp3.default)("chelonia/contract/currentKeyIdByName", state, "csk", true);
      if (!signingKeyId) {
        return;
      }
    ...
    (0, import_sbp3.default)("gi.actions/chatroom/leave", {
    ...
    actions: {
        ...
        sideEffect({ contractID }, { state }) {
          if (!state.generalChatRoomId) {
            (0, import_sbp3.default)("chelonia/queueInvocation", contractID, async () => {
              ...
              const CSKid = await (0, import_sbp3.default)("chelonia/contract/currentKeyIdByName", state2, "csk", true);
              const CEKid = await (0, import_sbp3.default)("chelonia/contract/currentKeyIdByName", state2, "cek");
              (0, import_sbp3.default)("gi.actions/group/addChatRoom", {
                contractID,
                data: {
                  attributes: {
      ...
      "gi.contracts/group/notifyExpiringProposals": {
        ...
        sideEffect({ data, height, contractID }, { state, getters }) {
          ...
          if (isActionNewerThanUserJoinedDate(height, myProfile)) {
            for (const proposalId of data.proposalIds) {
              const proposal = state.proposals[proposalId];
              (0, import_sbp3.default)("gi.notifications/emit", "PROPOSAL_EXPIRING", {
                groupID: contractID,
                proposal,
                proposalId
              });
      ...
      "gi.contracts/group/removeMember": {
        validate: actionRequireActiveMember((data, { state, getters, message: { innerSigningContractID, proposalHash } }) => {
          ...
          if (!state.profiles[memberToRemove]) {
            throw new GIGroupNotJoinedError((0, import_common3.L)("Not part of the group."));
          }
          if (membersCount === 1) {
        ...
        sideEffect({ data, meta, contractID, height, innerSigningContractID, proposalHash }, { state, getters }) {
          const memberID = data.memberID || innerSigningContractID;
          (0, import_sbp3.default)("chelonia/queueInvocation", contractID, () => (0, import_sbp3.default)("chelonia/contract/setPendingKeyRevocation", contractID, ["cek", "csk"]));
          (0, import_sbp3.default)("gi.contracts/group/referenceTally", contractID, memberID, "release");
          (0, import_sbp3.default)("chelonia/queueInvocation", contractID, () => (0, import_sbp3.default)("gi.contracts/group/leaveGroup", {
            data,
            meta,
            contractID,
            getters,
      ...
      "gi.contracts/group/inviteAccept": {
        ...
        sideEffect({ meta, contractID, height, innerSigningContractID }) {
          const { loggedIn } = (0, import_sbp3.default)("state/vuex/state");
          (0, import_sbp3.default)("gi.contracts/group/referenceTally", contractID, innerSigningContractID, "retain");
          (0, import_sbp3.default)("chelonia/queueInvocation", contractID, async () => {
            ...
            if (innerSigningContractID === userID) {
              ...
              if (generalChatRoomId) {
                if (state.chatRooms[generalChatRoomId]?.members?.[userID]?.status !== PROFILE_STATUS.ACTIVE) {
                  (0, import_sbp3.default)("gi.actions/group/joinChatRoom", {
                    contractID,
                    ...
                    (0, import_sbp3.default)("okTurtles.events/emit", ERROR_JOINING_CHATROOM, { identityContractID: userID, groupContractID: contractID, chatRoomID: generalChatRoomId });
                  });
                }
              } else {
                console.error("Couldn't join the chatroom in the group. Doesn't exist.", { chatroomName: CHATROOM_GENERAL_NAME });
                (0, import_sbp3.default)("okTurtles.events/emit", ERROR_GROUP_GENERAL_CHATROOM_DOES_NOT_EXIST, { identityContractID: userID, groupContractID: contractID });
              }
              (0, import_sbp3.default)("okTurtles.events/emit", JOINED_GROUP, { identityContractID: userID, groupContractID: contractID });
      ...
      "gi.contracts/group/addChatRoom": {
        ...
        validate: (data) => {
          ...
          const nameValidationMap = {
            [(0, import_common3.L)("Chatroom name cannot contain white-space")]: (v) => /\s/g.test(v),
            [(0, import_common3.L)("Chatroom name must be lower-case only")]: (v) => /[A-Z]/g.test(v)
          };
        ...
        sideEffect({ contractID, data }, { state }) {
          if (data.chatRoomID === state.generalChatRoomId) {
            (0, import_sbp3.default)("chelonia/queueInvocation", contractID, () => {
      ...
      "gi.contracts/group/deleteChatRoom": {
        ...
        sideEffect({ data, contractID, innerSigningContractID }) {
          (0, import_sbp3.default)("okTurtles.events/emit", DELETED_CHATROOM, { groupContractID: contractID, chatRoomID: data.chatRoomID });
          const { identityContractID } = (0, import_sbp3.default)("state/vuex/state").loggedIn;
          if (identityContractID === innerSigningContractID) {
            (0, import_sbp3.default)("gi.actions/chatroom/delete", { contractID: data.chatRoomID, data: {} }).catch((e) => {
      ...
      "gi.contracts/group/leaveChatRoom": {
        ...
        sideEffect({ data, contractID, innerSigningContractID }, { state }) {
          ...
          if (memberID === identityContractID) {
            (0, import_sbp3.default)("gi.contracts/group/referenceTally", contractID, data.chatRoomID, "release");
            (0, import_sbp3.default)("okTurtles.events/emit", LEFT_CHATROOM, {
              identityContractID,
      ...
      "gi.contracts/group/joinChatRoom": {
        ...
        sideEffect({ data, contractID, height, innerSigningContractID }) {
          ...
          const { identityContractID } = (0, import_sbp3.default)("state/vuex/state").loggedIn;
          if (memberID === identityContractID) {
            (0, import_sbp3.default)("gi.contracts/group/referenceTally", contractID, data.chatRoomID, "retain");
          }
          if (innerSigningContractID === identityContractID) {
            (0, import_sbp3.default)("chelonia/queueInvocation", contractID, () => (0, import_sbp3.default)("gi.contracts/group/joinGroupChatrooms", contractID, data.chatRoomID, identityContractID, memberID, height)).catch((e) => {
    ...
    methods: {
      "gi.contracts/group/_cleanup": ({ contractID, state }) => {
        ...
        if (dependentContractIDs.length) {
          (0, import_sbp3.default)("chelonia/contract/release", dependentContractIDs).catch((e) => {
            console.error("[gi.contracts/group/_cleanup] Error calling release", contractID, e);
          });
        }
        Promise.all(
          [
            () => (0, import_sbp3.default)("gi.contracts/group/removeArchivedProposals", contractID),
            () => (0, import_sbp3.default)("gi.contracts/group/removeArchivedPayments", contractID)
          ]
        ).catch((e) => {
      ...
      "gi.contracts/group/archiveProposal": async function(contractID, proposalHash, proposal) {
        ...
        (0, import_sbp3.default)("okTurtles.events/emit", PROPOSAL_ARCHIVED, contractID, proposalHash, proposal);
      },
      "gi.contracts/group/archivePayments": async function(contractID, archivingPayments) {
        ...
        for (const period of Object.keys(paymentsByPeriod).sort()) {
          ...
          while (Object.keys(archPaymentsByPeriod).length > MAX_ARCHIVED_PERIODS) {
            ...
            await (0, import_sbp3.default)("gi.db/archive/delete", `payments/${shouldBeDeletedPeriod}/${identityContractID}/${contractID}`);
      ...
      "gi.contracts/group/removeArchivedProposals": async function(contractID) {
        const { identityContractID } = (0, import_sbp3.default)("state/vuex/state").loggedIn;
        const key = `proposals/${identityContractID}/${contractID}`;
        await (0, import_sbp3.default)("gi.db/archive/delete", key);
      },
      "gi.contracts/group/removeArchivedPayments": async function(contractID) {
        const { identityContractID } = (0, import_sbp3.default)("state/vuex/state").loggedIn;
        const archPaymentsByPeriodKey = `paymentsByPeriod/${identityContractID}/${contractID}`;
        const periods = Object.keys(await (0, import_sbp3.default)("gi.db/archive/load", archPaymentsByPeriodKey) || {});
        const archSentOrReceivedPaymentsKey = `sentOrReceivedPayments/${identityContractID}/${contractID}`;
        for (const period of periods) {
          const archPaymentsKey = `payments/${identityContractID}/${period}/${contractID}`;
          await (0, import_sbp3.default)("gi.db/archive/delete", archPaymentsKey);
        }
        await (0, import_sbp3.default)("gi.db/archive/delete", archPaymentsByPeriodKey);
        await (0, import_sbp3.default)("gi.db/archive/delete", archSentOrReceivedPaymentsKey);
      },
      "gi.contracts/group/makeNotificationWhenProposalClosed": function(state, contractID, meta, height, proposalHash, proposal) {
        ...
        if (isActionNewerThanUserJoinedDate(height, state.profiles[loggedIn.identityContractID])) {
          (0, import_sbp3.default)("gi.notifications/emit", "PROPOSAL_CLOSED", { createdDate: meta.createdDate, groupID: contractID, proposalHash, proposal });
        }
      },
      "gi.contracts/group/sendMincomeChangedNotification": async function(contractID, meta, data, height, innerSigningContractID) {
        const { identityContractID } = (0, import_sbp3.default)("state/vuex/state").loggedIn;
        const myProfile = (await (0, import_sbp3.default)("chelonia/contract/state", contractID)).profiles[identityContractID];
        ...
        if (isActionNewerThanUserJoinedDate(height, myProfile) && myProfile.incomeDetailsType) {
          ...
          (0, import_sbp3.default)("gi.notifications/emit", "MINCOME_CHANGED", {
            createdDate: meta.createdDate,
            groupID: contractID,
            creatorID: innerSigningContractID,
            to: toAmount,
      ...
      "gi.contracts/group/joinGroupChatrooms": async function(contractID, chatRoomID, originalActorID, memberID, height) {
        const state = await (0, import_sbp3.default)("chelonia/contract/state", contractID);
        const actorID = (0, import_sbp3.default)("state/vuex/state").loggedIn.identityContractID;
        ...
        {
          await (0, import_sbp3.default)("chelonia/contract/retain", chatRoomID, { ephemeral: true });
          if (!await (0, import_sbp3.default)("chelonia/contract/hasKeysToPerformOperation", chatRoomID, "gi.contracts/chatroom/join")) {
            throw new Error(`Missing keys to join chatroom ${chatRoomID}`);
          }
          const encryptionKeyId = (0, import_sbp3.default)("chelonia/contract/currentKeyIdByName", state, "cek", true);
          (0, import_sbp3.default)("gi.actions/chatroom/join", {
            contractID: chatRoomID,
            ...
            (0, import_sbp3.default)("chelonia/contract/release", chatRoomID, { ephemeral: true }).catch((e) => console.error("[gi.contracts/group/joinGroupChatrooms] Error during release", e));
          });
        }
      },
      ...
      "gi.contracts/group/leaveGroup": async ({ data, meta, contractID, height, getters, innerSigningContractID, proposalHash }) => {
        ...
        if (memberID === identityContractID) {
          const areWeRejoining = async () => {
            const pendingKeyShares = await (0, import_sbp3.default)("chelonia/contract/waitingForKeyShareTo", state, identityContractID);
            if (pendingKeyShares) {
            ...
            const sentKeyShares = await (0, import_sbp3.default)("chelonia/contract/successfulKeySharesByContractID", state, identityContractID);
        ...
        if (memberID === identityContractID) {
          (0, import_sbp3.default)("gi.actions/identity/leaveGroup", {
          ...
          if (isActionNewerThanUserJoinedDate(height, myProfile)) {
            ...
            Promise.resolve().then(() => (0, import_sbp3.default)("gi.contracts/group/rotateKeys", contractID)).then(() => (0, import_sbp3.default)("gi.contracts/group/revokeGroupKeyAndRotateOurPEK", contractID)).catch((e) => {
              console.warn(`[gi.contracts/group/leaveGroup] for ${contractID}: Error rotating group keys or our PEK`, e);
            });
            await (0, import_sbp3.default)("gi.contracts/group/removeForeignKeys", contractID, memberID, state);
          }
        }
      },
      "gi.contracts/group/rotateKeys": async (contractID) => {
        ...
        (0, import_sbp3.default)("gi.actions/out/rotateKeys", contractID, "gi.contracts/group", "pending", "gi.actions/group/shareNewKeys").catch((e) => {
      ...
      "gi.contracts/group/removeForeignKeys": async (contractID, userID, state) => {
        const keyIds = await (0, import_sbp3.default)("chelonia/contract/foreignKeysByContractID", state, userID);
      ...
      "gi.contracts/group/sendNonMonetaryUpdateNotification": ({
        ...
        if (!isUpdatingMyself) {
          const myProfile = getters.groupProfile(loggedIn.identityContractID);
          if (isActionNewerThanUserJoinedDate(height, myProfile)) {
            (0, import_sbp3.default)("gi.notifications/emit", "NONMONETARY_CONTRIBUTION_UPDATE", {
              createdDate: meta.createdDate,
              groupID: contractID,
              creatorID: innerSigningContractID,
              updateData
