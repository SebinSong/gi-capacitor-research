...
var HTML5History = /* @__PURE__ */ function(History3) {
  ...
  HTML5History2.prototype.setupListeners = function setupListeners2() {
    ...
    var handleRoutingEvent = function() {
      ...
      var location2 = getLocation(this$1.base);
      if (this$1.current === START && location2 === this$1._startLocation) {
        return;
      }
      this$1.transitionTo(location2, function(route) {
        if (supportsScroll) {
...
VueRouter.prototype.push = function push(location2, onComplete, onAbort) {
  ...
  if (!onComplete && !onAbort && typeof Promise !== "undefined") {
    return new Promise(function(resolve2, reject) {
      this$1.history.push(location2, resolve2, reject);
    });
  } else {
...
VueRouter.prototype.replace = function replace(location2, onComplete, onAbort) {
  ...
  if (!onComplete && !onAbort && typeof Promise !== "undefined") {
    return new Promise(function(resolve2, reject) {
      this$1.history.replace(location2, resolve2, reject);
    });
  } else {
...
function ignoreWhenNavigationCancelled(err, path) {
  const { isNavigationFailure: isNavigationFailure2, NavigationFailureType: NavigationFailureType2 } = vue_router_esm_default;
  if (isNavigationFailure2(err, NavigationFailureType2.cancelled)) {
...
function validateURL(url, acceptPathOnly = false) {
  const response = {
    isValid: false,
    isHttpValid: false,
    isMailtoValid: false,
  ...
  if (acceptPathOnly) {
    const regExpMap = {
      pathOnly: /^\/[^\s]*$/,
      // eg. /app/chatroom/chatID, /to-a-path,
      slugPiece: /^[a-zA-Z0-9_-]+$/,
      // eg. contributions, payments, dashboard, abc_123
      slugPieceWithLeadingSharp: /^#[a-zA-Z0-9_-]+$/,
      // eg. #hello, #user_123, #valid-ID
      queryString: /^\?(?:[a-zA-Z0-9_-]+=[^&]*)(?:&[a-zA-Z0-9_-]+=[^&]*)*$/
      // eg. ?modal=ModalName&userId=abcd123
    };
...
function withGroupCurrency(amount) {
  const code = esm_default("state/vuex/getters").groupSettings?.mincomeCurrency;
  if (code === void 0) {
...
vue-router/dist/vue-router.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=chunk-OBUPKMDO-cached.js.map
