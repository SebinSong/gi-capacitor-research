...
// frontend/views/components/QrCode.vue
var import_qrious = __toESM(require_qrious());
var __vue_script__ = {
  name: "QrCode",
  props: {
    pixelSize: {
  ...
  computed: {
    ...
    colorSet() {
      return {
        foreground: this.isDarkTheme ? "#E8E8E8" : "#363636",
        // var(--text_0)
        background: this.isDarkTheme ? "#383C3E" : "#FFFFFF"
        // var(--background_0)
      };
    },
    qriousConfig() {
  ...
  methods: {
    createInstance() {
      ...
      this.ephemeral.qr = new import_qrious.default({
        ...this.qriousConfig,
        element: canvasEl
      });
    },
...
var __vue_render__ = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "c-qr-code",
      style: { "--side-length": _vm.sideLength + "px" }
    },
    [
      !_vm.value ? _c("div", { staticClass: "c-qr-loading-ani" }) : _c("canvas", { ref: "canvas", staticClass: "c-qr-canvas" })
    ]
  );
};
...
var __vue_inject_styles__ = function(inject) {
  if (!inject) return;
  inject("data-v-665f195a_0", { source: ".c-qr-code[data-v-665f195a] {\n  position: relative;\n  display: inline-block;\n  width: var(--side-length);\n  height: var(--side-length);\n  overflow: hidden;\n}\n.c-qr-loading-ani[data-v-665f195a],\n.c-qr-canvas[data-v-665f195a] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: inherit;\n  height: inherit;\n}\n.c-qr-loading-ani[data-v-665f195a] {\n  background-color: rgba(0, 0, 0, 0.1);\n}\n.c-qr-canvas[data-v-665f195a] {\n  z-index: 1;\n  transform-origin: center center;\n  transform: scale(1.05);\n}\n\n/*# sourceMappingURL=QrCode.vue.map */", map: { "version": 3, "sources": ["frontend/views/components/QrCode.vue", "QrCode.vue"], "names": [], "mappings": "AAqGA;EACA,kBAAA;EACA,qBAAA;EACA,yBAAA;EACA,0BAAA;EACA,gBAAA;ACpGA;ADuGA;;EAEA,kBAAA;EACA,MAAA;EACA,OAAA;EACA,cAAA;EACA,eAAA;ACpGA;ADuGA;EACA,oCAAA;ACpGA;ADuGA;EACA,UAAA;EACA,+BAAA;EAGA,sBAAA;ACtGA;;AAEA,qCAAqC", "file": "QrCode.vue", "sourcesContent": [`<template lang="pug">
...
`, ".c-qr-code {\n  position: relative;\n  display: inline-block;\n  width: var(--side-length);\n  height: var(--side-length);\n  overflow: hidden;\n}\n\n.c-qr-loading-ani,\n.c-qr-canvas {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: inherit;\n  height: inherit;\n}\n\n.c-qr-loading-ani {\n  background-color: rgba(0, 0, 0, 0.1);\n}\n\n.c-qr-canvas {\n  z-index: 1;\n  transform-origin: center center;\n  transform: scale(1.05);\n}\n\n/*# sourceMappingURL=QrCode.vue.map */"] }, media: void 0 });
};
var __vue_scope_id__ = "data-v-665f195a";
...
var QrCode_default = __vue_component__;

// frontend/views/components/CopyableInput.vue
var __vue_script__2 = {
  name: "CopyableInput",
  components: {
  ...
  methods: {
    ...
    copyToClipboard() {
      ...
      if (navigator.clipboard) {
        navigator.clipboard.writeText(this.value).then(showTooltip);
      } else {
...
var __vue_render__2 = function() {
  ...
  return _c(
    "div",
    { staticClass: "inputgroup c-wrapper" },
    [
      _c("input", {
        ref: "input",
        staticClass: "input c-input",
        attrs: { disabled: _vm.uneditable },
      ...
      _c("div", { staticClass: "addons" }, [
        _c(
          "button",
          {
            staticClass: "is-icon c-btn",
            attrs: { "aria-lebel": _vm.L("Copy string") },
      ...
      _vm.ephemeral.isTooltipActive ? _c("tooltip", {
        ...
        class: "is-direction-" + _vm.tooltipDirection,
        attrs: {
          isVisible: true,
...
var __vue_inject_styles__2 = function(inject) {
  if (!inject) return;
  inject("data-v-6bfc35b8_0", { source: ".c-input[data-v-6bfc35b8] {\n  font-size: 0.875rem;\n  height: 2rem;\n  padding: 0 0.5rem;\n  padding-right: 2.25rem;\n  min-width: 10.875rem;\n}\n@media screen and (min-width: 1200px) {\n.c-wrapper .addons[data-v-6bfc35b8] {\n    margin-right: -4px;\n}\n}\n.inputgroup .addons button.is-icon.c-btn[data-v-6bfc35b8] {\n  font-size: 0.875rem;\n  width: 2rem;\n  border-left: 1px solid var(--general_0);\n}\n.c-feedback[data-v-6bfc35b8] {\n  position: absolute;\n  left: 50%;\n  transform: translateX(-50%);\n}\n.c-feedback.is-direction-bottom[data-v-6bfc35b8] {\n  transform: translateX(-50%) translateY(0.25rem);\n}\n.c-feedback.is-direction-top[data-v-6bfc35b8] {\n  transform: translateX(-50%) translateY(-0.25rem);\n}\n\n/*# sourceMappingURL=CopyableInput.vue.map */", map: { "version": 3, "sources": ["frontend/views/components/CopyableInput.vue", "CopyableInput.vue"], "names": [], "mappings": "AAgFA;EACA,mBAAA;EACA,YAAA;EACA,iBAAA;EACA,sBAAA;EACA,oBAAA;AC/EA;AAEA;ADiFA;IAEA,kBAAA;AChFE;AACF;ADoFA;EACA,mBAAA;EACA,WAAA;EACA,uCAAA;ACjFA;ADoFA;EACA,kBAAA;EACA,SAAA;EACA,2BAAA;ACjFA;ADmFA;EACA,+CAAA;ACjFA;ADoFA;EACA,gDAAA;AClFA;;AAEA,4CAA4C", "file": "CopyableInput.vue", "sourcesContent": [`<template lang="pug">
...
`, ".c-input {\n  font-size: 0.875rem;\n  height: 2rem;\n  padding: 0 0.5rem;\n  padding-right: 2.25rem;\n  min-width: 10.875rem;\n}\n\n@media screen and (min-width: 1200px) {\n  .c-wrapper .addons {\n    margin-right: -4px;\n  }\n}\n\n.inputgroup .addons button.is-icon.c-btn {\n  font-size: 0.875rem;\n  width: 2rem;\n  border-left: 1px solid var(--general_0);\n}\n\n.c-feedback {\n  position: absolute;\n  left: 50%;\n  transform: translateX(-50%);\n}\n.c-feedback.is-direction-bottom {\n  transform: translateX(-50%) translateY(0.25rem);\n}\n.c-feedback.is-direction-top {\n  transform: translateX(-50%) translateY(-0.25rem);\n}\n\n/*# sourceMappingURL=CopyableInput.vue.map */"] }, media: void 0 });
};
var __vue_scope_id__2 = "data-v-6bfc35b8";
...
var CopyableInput_default = __vue_component__2;

export {
  QrCode_default,
  CopyableInput_default
};
//# sourceMappingURL=chunk-LK3YAPWY-cached.js.map
