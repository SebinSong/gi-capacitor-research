  ...
  esm_default("okTurtles.data/set", PUBSUB_INSTANCE, esm_default("chelonia/connect", {
    messageHandlers: {
      [NOTIFICATION_TYPE.VERSION_INFO](msg) {
        const ourVersion = "2.5.1@2026-01-22T10:19:51.672Z";
...
console.info("GI_VERSION:", "2.5.1@2026-01-22T10:19:51.672Z");
console.info("GI_GIT_VERSION:", "v2.5.1-27-g8b878ca6-dirty");
...
esm_default("sbp/selectors/register", {
  "sw/version": () => {
    return {
      GI_VERSION: "2.5.1@2026-01-22T10:19:51.672Z",
      GI_GIT_VERSION: "v2.5.1-27-g8b878ca6-dirty",
